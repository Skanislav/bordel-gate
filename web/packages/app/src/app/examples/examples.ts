...
export const EXAMPLE_ITEMS = [
  ...
  {
    title: 'Prove ECDSA Signature',
    description:
      'Sign a message with your wallet, then generate a Noir zero-knowledge proof in the browser that the signature is valid — pubkey and signature stay private.',
    image: TokenIcon.src,
